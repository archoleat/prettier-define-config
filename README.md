...
![Markdown](https://img.shields.io/github/actions/workflow/status/archoleat/prettier-define-config/markdown.yaml?label=Markdown)
...
```shell
# pnpm
pnpm i -D @archoleat/prettier-define-config
```

```shell
# npm
npm i -D @archoleat/prettier-define-config
```

```shell
# yarn
yarn add -D @archoleat/prettier-define-config
```
